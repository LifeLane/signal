...
3.  **Analyze Technical Indicators:** Use the data from \`fetchMarketData\` to form a concise, one-sentence interpretation for each technical indicator.
...
4.  **Synthesize and Decide Signal:** Combine the news sentiment and all technical indicator analyses to decide on a final trading signal ('BUY', 'SELL', or 'HOLD'), strictly following the **Risk Level Instructions**.
5.  **Generate Justification:** Based on your synthesis in the previous step, write a concise, one-sentence justification for the final signal. Example: "The BUY signal is based on strong bullish indicators like the EMA and Parabolic SAR, combined with positive market news." or "A HOLD signal is recommended as technical indicators are mixed and recent news suggests market uncertainty."
